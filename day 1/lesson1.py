name = "Giorgi"
# name არის ცვლადი
# "Giorgi" არის ცვლადისთვის მნიშვნელობის მიმნიჭებელი სიმბოლო
...
name = "Giorgi" # ეს არის tr ( string ) ტიპის ცვლადი
age = 13 # ეს არის int ( integer ) მთელი რიცხვი
height = 169.5 # ეს არის float ტიპის ცვლადი ( ათწილადი )
...
# string არის ბრჭყალებში მოქცეული სიმბოლოები
# print(name + age)
